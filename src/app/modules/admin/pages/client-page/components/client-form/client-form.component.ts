...
export class ClientFormComponent implements OnInit {
  ...
  initForm(): FormGroup {
    return this.formBuilder.group({
      name: ['', [Validators.required, Validators.minLength(3), Validators.maxLength(20),Validators.pattern('^[a-zA-ZáéíóúñÁÉÍÓÚÑ ]+$')]],
      last_name: ['', [Validators.required, Validators.pattern('^[a-zA-ZáéíóúñÁÉÍÓÚÑ ]+$'), Validators.minLength(3), Validators.maxLength(20)]],
